          ...
          <div className="grid hero-content text-center text-neutral-content lg:p-20">
            <div className="text-secondary">
              ...
              <div>
                ...
                <label htmlFor="newUser" className="btn m-1">
              ...
              {/* Div for searching, editing and removing users, only on small screens visible */}
              <div className="flex flex-row justify-center lg:hidden">
                <div>
                  <select className="select select-bordered w-full max-w-xs mb-5 mt-5">
                    <option disabled selected>
                      Nutzer suchen
                    </option>
              ...
              <div className="overflow-x-auto pt-10 hidden lg:flex">
