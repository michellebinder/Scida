...
export async function getServerSideProps({ req, query }) {
  ...
  if (role === "B") {
    ...
    sqlQuery =
      "SELECT * FROM attendance WHERE attendance.sess_id = ? AND attendance.group_name = ? AND attendance.lecturer_id = ?;";
  } else if (role === "scidaDekanat" || role === "scidaSekretariat") {
    sqlQuery =
      "SELECT * FROM attendance WHERE attendance.sess_id = ? AND attendance.group_name = ?;";
  }
