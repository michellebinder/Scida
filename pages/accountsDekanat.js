                  ...
                  <div className="flex flex-row">
                        ...
                        <div className="w-11/12 max-w-5xl">
                          ...
                          <div>
                            ...
                            >
                              ...
                              <input
                                onChange={(e) =>
                                  createFirstName(e.target.value)
                                }
                                value={firstName}
                                id="firstName"
                                name="firstName"
                    ...
                    <div className="card card-normal bg-primary text-primary-content mr-3 basis-1/2">
                      <div className="card-body">
                        ...
                        <div className="w-11/12 max-w-5xl">
                          <p className="text-left mb-5">
                            Bearbeite oder lösche Nutzende hier. Gib in das
                            Suchfeld Namen, Matrikelnummer oder E-Mail Adresse
                            ein.<br></br> Dann kannst du den Nutzenden
                          ...
                          <div>
                            ...
                            <label className="input-group pb-5 flex justify-left text-neutral dark:text-white">
                              ...
                              <input
                                ...
                                value={editFirstName}
                                onChange={(e) =>
                                  updateEditFirstName(e.target.value)
                                }
                                placeholder="Muster"
                                className="input input-bordered"
                              />
                            ...
                            <label className="input-group pb-5 flex justify-left text-neutral dark:text-white">
                              ...
                              <input
                                ...
                                value={editLastName}
                                onChange={(e) =>
                                  updateEditLastName(e.target.value)
                                }
                                placeholder="Muster"
                                className="input input-bordered"
                              />
                            ...
                            <label className="input-group pb-5 flex justify-left text-neutral dark:text-white">
                              ...
                              <input
                                ...
                                value={editEmail}
                                onChange={(e) =>
                                  updateEditEmail(e.target.value)
                                }
                                placeholder="muster@smail.uni-koeln.de"
                                className="input input-bordered"
                              />
                            ...
                            <div className="flex flex-row">
                              ...
                              >
                                ...
                                >
                                  {/* TODO backend: check whether the user really has been added successfully */}
                                  <p className="text-lg font-bold text-neutral">
                                    Der/die Nutzer:in wurde erfolgreich
                                    erstellt!
                                  </p>
                                </label>
                              </label>
                            ...
                            <div className="modal">
                              <div className="modal-box">
                                <p className="py-4 text-lg font-bold text-accent">
                                  Bist du sicher, dass du diese:n Nutzer:in
                                  löschen möchtest?
                                  <br></br>Das kann nicht rückgängig gemacht
                                  werden.
                                </p>
