  ...
  return (
    <div className="w-full rounded-md shadow-lg">
      ...
      <button
        ...
        className="px-4 py-2 w-full font-bold text-primary group flex items-center focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-primary transition duration-150 ease-in-out"
      >
