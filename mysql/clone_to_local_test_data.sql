...
CREATE TABLE csv(
  ...
  ,SPOVersion     VARCHAR(200) NOT NULL
  ,StudienID      VARCHAR(50) NOT NULL
  ,Studium        VARCHAR(100) NOT NULL
  ,Fachsemester   INTEGER  NOT NULL
  ,Anmeldedatum   VARCHAR(32) NOT NULL
  ,Kennzahl       VARCHAR(25) NOT NULL
  ,Semester       VARCHAR(32) /* NOT NULL */
  ,PRIMARY KEY (Matrikelnummer,Gruppe,Fachsemester, Semester)
);
...
INSERT INTO accounts ( first_name, last_name, email, account_pwd, account_role) value ('Anton','Admin','admin@admin','a85b6a20813c31a8b1b3f3618da796271c9aa293b3f809873053b21aec501087', 'scidaDekanat');
...
INSERT INTO accounts ( first_name, last_name, email, account_pwd, account_role) value ('Dora','Dekanat','dekanat@test.de','a8327d4a49d4631631d090a72297d8d749337a30e6eb0416bd3655b71e36481b', 'scidaDekanat');
INSERT INTO accounts ( first_name, last_name, email, account_pwd, account_role) value ('Dieter','Doz','dozierende@test.de','a8327d4a49d4631631d090a72297d8d749337a30e6eb0416bd3655b71e36481b', 'B');/*  B for externe Dozierende */
...
CREATE TABLE csv_sessions(
  ...
  ,vortragende_kontaktperson_email  VARCHAR(300) NOT NULL
  ,semester           VARCHAR(11) NOT NULL
